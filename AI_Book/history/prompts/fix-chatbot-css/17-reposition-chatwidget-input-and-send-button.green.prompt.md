...
Update the chatbot UI in my Docusaurus project. Wrap the input and send button in a div positioned at the bottom of the chat window using flexbox. Ensure the message area takes up all available space above it.
